...
2. 상품 리서치 센터에서 공식 출처 기반 상품정보 구조화 확인
3. 고객 니즈 분석에서 고객 선택
4. 상품 통합 비교에서 여러 보험사 상품 비교
5. 비교 기준을 바꿔 결과가 달라지는 것 확인
6. AI 추천 랭킹에서 고객별 TOP 5 확인
7. 한화생명 전략상품 화면에서 한화 상품 상담 포인트 확인
8. 상담 멘트 생성
9. 제안서 요약 화면 확인
10. 서비스 소개에서 실제 운영 확장 방향 설명
